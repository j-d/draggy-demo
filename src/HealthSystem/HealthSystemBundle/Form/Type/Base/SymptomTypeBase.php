<?php
// HealthSystem\HealthSystemBundle\Form\Type\Base\SymptomTypeBase.php
...
abstract class SymptomTypeBase extends AbstractType
{
    /**
     ...
     * @var string
     */
    protected $defaultOptionsDataClass = 'HealthSystem\HealthSystemBundle\Entity\Symptom';
    ...
    {
        return 'healthsystem_healthsystem_symptom';
    }
