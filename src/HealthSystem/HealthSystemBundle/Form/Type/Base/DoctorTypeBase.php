<?php
// HealthSystem\HealthSystemBundle\Form\Type\Base\DoctorTypeBase.php
...
abstract class DoctorTypeBase extends AbstractType
{
    /**
     ...
     * @var string
     */
    protected $defaultOptionsDataClass = 'HealthSystem\HealthSystemBundle\Entity\Doctor';
    ...
    {
        return 'healthsystem_healthsystem_doctor';
    }
