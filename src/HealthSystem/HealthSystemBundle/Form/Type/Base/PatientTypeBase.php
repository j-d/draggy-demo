<?php
// HealthSystem\HealthSystemBundle\Form\Type\Base\PatientTypeBase.php
...
abstract class PatientTypeBase extends AbstractType
{
    /**
     ...
     * @var string
     */
    protected $defaultOptionsDataClass = 'HealthSystem\HealthSystemBundle\Entity\Patient';
     ...
     * @return SymptomType
     */
    protected function getSymptomsFieldParentFormConstructor($arguments)
    {
     ...
     * @return array
     */
    public function getSymptomsField($arguments = [])
    {
        return [
            'name' => 'symptoms',
            'type' => 'entity',
     ...
     */
    protected function getAppointmentsFieldParentFormConstructor($arguments)
    {
     ...
     * @return array
     */
    public function getAppointmentsField($arguments = [])
    {
        return [
            'name' => 'appointments',
            'type' => 'collection',
    ...
    {
        return 'healthsystem_healthsystem_patient';
    }
