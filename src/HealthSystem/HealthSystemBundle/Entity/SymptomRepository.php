<?php
// HealthSystem\HealthSystemBundle\Entity\SymptomRepository.php
...
/**
 * HealthSystem\HealthSystemBundle\Entity\SymptomRepository
 */
class SymptomRepository extends EntityRepository
{
    ...
    function __construct($em)
    {
        ...
        $metadata = $em->getClassMetadata('HealthSystemBundle:Symptom');
