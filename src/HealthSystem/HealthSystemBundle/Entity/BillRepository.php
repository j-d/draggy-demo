<?php
// HealthSystem\HealthSystemBundle\Entity\BillRepository.php
...
/**
 * HealthSystem\HealthSystemBundle\Entity\BillRepository
 */
class BillRepository extends EntityRepository
{
    ...
    function __construct($em)
    {
        ...
        $metadata = $em->getClassMetadata('HealthSystemBundle:Bill');
