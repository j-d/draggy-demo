<?php
// HealthSystem\HealthSystemBundle\Entity\DoctorRepository.php
...
/**
 * HealthSystem\HealthSystemBundle\Entity\DoctorRepository
 */
class DoctorRepository extends EntityRepository
{
    ...
    function __construct($em)
    {
        ...
        $metadata = $em->getClassMetadata('HealthSystemBundle:Doctor');
