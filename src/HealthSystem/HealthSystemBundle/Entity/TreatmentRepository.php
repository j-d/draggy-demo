<?php
// HealthSystem\HealthSystemBundle\Entity\TreatmentRepository.php
...
/**
 * HealthSystem\HealthSystemBundle\Entity\TreatmentRepository
 */
class TreatmentRepository extends EntityRepository
{
    ...
    function __construct($em)
    {
        ...
        $metadata = $em->getClassMetadata('HealthSystemBundle:Treatment');
